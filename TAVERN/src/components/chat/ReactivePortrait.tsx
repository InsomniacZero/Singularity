...
export function ReactivePortrait({ spriteUrl, alt }: { spriteUrl: string | undefined; alt: string }) {
  ...
  return (
    <div
      ...
      className="animate-panel-in pointer-events-none absolute right-4 top-4 z-10 hidden overflow-hidden rounded-xl border border-border/80 bg-bg-elevated/95 shadow-xl ring-1 ring-romance/20 sm:block"
      aria-hidden="true"
    >
      <img
        src={displaySrc}
