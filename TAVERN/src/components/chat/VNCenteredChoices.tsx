...
import { Gift, MessageSquare, RotateCcw, X, Zap, type LucideIcon } from 'lucide-react'
    ...
    <div className="vn-centered-choices pointer-events-none absolute inset-x-0 top-0 z-30 flex h-[78%] flex-col items-center justify-center gap-3 px-5">
        ...
        {choices.map((choice, i) => {
          ...
          return (
            <button
              ...
              className="vn-choice-row vn-glass group/choice relative flex w-full items-center gap-3 overflow-hidden rounded-xl py-3.5 pl-4 pr-5 text-left text-[15px] text-white/90 transition-[color,background-color,transform] duration-150 hover:translate-x-1 hover:bg-white/[0.14] hover:text-white"
            >
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="vn-glass pointer-events-auto relative flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs text-white/55 transition-colors hover:bg-white/20 hover:text-white disabled:opacity-40"
        >
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            title="Dismiss options (Esc)"
            aria-label="Dismiss options"
            className="vn-glass pointer-events-auto relative flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs text-white/55 transition-colors hover:bg-white/20 hover:text-white"
          >
