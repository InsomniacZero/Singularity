    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-5 lg:grid-cols-4">
        {worlds.map((w) => (
          ...
          >
            <div className="portrait-frame mb-3 aspect-[4/3] w-full overflow-hidden rounded-lg border border-border/50 bg-bg-sunken">
              {w.avatarDataUrl ? (
                <img src={w.avatarDataUrl} alt="" className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-[1.02]" />
              ) : (
            ...
            <div className="truncate px-0.5 text-sm font-semibold text-text group-hover:text-accent transition-colors">{w.name}</div>
