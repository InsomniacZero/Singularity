...
import { ReasoningPulseLoader } from '@/components/ui/Loaders'
          ...
          return (
            <div key={i}>
              ...
              >
                ...
                {isWriting && <span className="h-2 w-2 rounded-full bg-accent animate-pulse shrink-0" />}
          ...
          <div className="mx-auto max-w-chat space-y-5">
            ...
            {progress && (
              <div className="max-w-xs">
                <ReasoningPulseLoader label={`${progress.label}…`} />
              </div>
            )}
            {isBusy && !streamingText && !progress && (
              <div className="max-w-xs">
                <ReasoningPulseLoader label="Thinking…" />
              </div>
            )}
            <div ref={bottomRef} />
          </div>
          ...
          <div className="mx-auto max-w-chat">
            ...
            <div className="flex items-end gap-2">
              <textarea
                ...
                className="min-h-[52px] flex-1 resize-y rounded-lg border border-border/80 bg-bg px-3 py-2 text-sm text-text outline-none transition-all focus:border-accent/60 focus:ring-1 focus:ring-accent/50"
              />
              {isBusy ? (
