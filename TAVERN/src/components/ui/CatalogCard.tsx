    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1.5">
          ...
          {owned > 0 && (
            <span className="shrink-0 rounded-md bg-bg-sunken px-1.5 py-0.5 text-[10px] tabular-nums font-medium text-text-muted">
              ×{owned}
            </span>
          )}
        </div>
...
export function CoinBalance({ coins }: { coins: number }) {
  return (
    <span className="flex shrink-0 items-center gap-1.5 rounded-lg bg-warning/12 px-2.5 py-1 text-xs font-medium text-warning">
