  ...
  return (
    ...
    >
      <div
        ...
        className={`animate-panel-in flex w-full max-w-sm flex-col rounded-xl border border-border/80 bg-bg-elevated/95 p-6 shadow-2xl backdrop-blur-xl ${vnChrome}`}
      >
