...
Built by **InsomniacZero** and **ZeroNine1**, adapted from [pnotisdev](https://github.com/pnotisdev), against [KoboldCpp](https://github.com/LostRuins/koboldcpp), and owing a debt to [SillyTavern](https://github.com/SillyTavern/SillyTavern) and the wider local-model and visual-novel communities whose formats and conventions this tries to meet rather than reinvent.
